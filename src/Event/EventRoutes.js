...
router.post("/create-event", async (req, res) => {
  ...
  // so check if the ID token exists in the header, and if it does,
  // validate the token in our 'validateUserSession' function, if if that succeeds,
  // Only then create an event
  if (
